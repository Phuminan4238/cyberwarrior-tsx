                ...
                <div className="grid items-center mb-6">
                  ...
                  <div className="text-black space-y-5 pt-4">
                    <p className="text-sm-7 md:text-lg/8 mb-4 ">
                      ...
                      และจะมีอีเมลยืนยันการลงทะเบียนส่งถึงคุณ <br></br> ภายใน 1
                      ชั่วโมง ในกรณีที่คุณไม่ได้รับอีเมลยืนยัน กรุณาติดต่อทีมงาน
                      และแสดงหน้าจอนี้พร้อมเวลาที่ส่งใบสมัคร” <br></br>
                      <br></br>
